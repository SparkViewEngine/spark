...
namespace Spark.Tests.Bindings
{
    ...
    public class BindingExecutionTester
    {
        ...
        public void ElementReplacedWithSimpleString()
        {
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello/></p>");
        ...
        {
            _viewFolder.Add("bindings.xml", @"<bindings><element name='hello'>World()</element></bindings>");
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello/></p><macro name='World'>success</macro>");
        ...
        public void ElementReplacedWithMacroCallAndAnArgument()
        {
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='alpha'/></p><macro name='World' beta='string'>success ${beta}!</macro>");
        ...
        {
            _viewFolder.Add("bindings.xml", @"<bindings><element name='hello'>World('@foo')</element></bindings>");
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='${3+4}'/></p><macro name='World' beta='int'>success ${beta}!</macro>");
        ...
        {
            _viewFolder.Add("bindings.xml", @"<bindings><element name='hello'>World('@foo')</element></bindings>");
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='one ${3+4} two ${SiteRoot} three'/></p><macro name='World' beta='string'>success ${beta}!</macro>");
...
<element name='hello'>""bar is "" + '@bar' + ""!""</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='one'/>, <hello bar='two'/></p>");
...
<element name='hello'>Callback(new{'@*'})</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='one'/>, <hello bar='two'/>, <hello foo='-${SiteRoot}-' bar='four'/></p><viewdata Callback='System.Func[[object,string]]'/>");
...
<element name='hello'>Callback(""nada"", new{'@*'})</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='one'/>, <hello bar='two'/>, <hello foo='-${SiteRoot}-' bar='four'/></p><viewdata Callback='System.Func[[string,object,string]]'/>");
...
<element name='hello'>Callback('@foo', new{'@*'}, new{'@route.*'})</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello foo='one'/>, <hello foo='one' bar='two'/>, <hello foo='one' bar='${2}' route.id='three' /></p><viewdata Callback='System.Func[[string,object,object,string]]'/>");
...
<element name='hello'><start>@a</start><end>@b</end></element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello a='3' b='5'>world</hello></p>");
            var contents = Render("index");
...
<element name='hello'>'@a' + child::* + '@b'</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello a='3' b='5'>(8+7)+""4""${55}</hello></p>");
            var contents = Render("index");
...
<element name='hello'>'@a' + ""no text"" + '@b'</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello a='1' b='2'>world</hello><hello a='3' b='4'></hello><hello a='5' b='6'/></p>");
...
<element name='hello'>new System.Collections.Generic.Dictionary&lt;string,object&gt;{{'@*'}}.Count</element>
            ...
            _viewFolder.Add(string.Format("home{0}index.spark", Path.DirectorySeparatorChar), @"<p><hello a='foo' b='bar'/><hello/><hello></hello><hello x1='' x2='' x3='' x4='' x5=''/></p>");
